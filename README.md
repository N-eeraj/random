...
## RandomNumber
The `RandomNumber` class provides four static methods to generate random values based on the provided arguments. You can use these methods to generate random integers, floating-point numbers, and arrays of random values.
<br />
